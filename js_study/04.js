...
//JOSN.stringify() => 자바스크립트 객체 또는 배열을 JSON형식의 문자열로 변환
...
console.log(student.find((s) => s.name === "주송헌"));

//값 존재 여부: includes() - 배열에 특정 값이 포함되어 있는지 boolean으로 반환
console.log(names.includes("빡빡육"));
...
console.log(student.filter((student) => student.age === 17));
//자바식
